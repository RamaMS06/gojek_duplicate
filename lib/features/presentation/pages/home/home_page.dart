...
import 'package:gojek_duplicate/features/presentation/blocs/submenu_home/submenu_home_bloc.dart';
import 'package:gojek_duplicate/features/presentation/blocs/treasure_home/treasure_home_bloc.dart';
import 'package:gojek_duplicate/features/presentation/widgets/shimmer.dart';
import 'package:gojek_duplicate/features/presentation/widgets/sub_menu.dart';
...
class HomePage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MultiBlocProvider(
      providers: [
        BlocProvider(create: (_) => CardHomeBloc()..add(CardGetDataEvent())),
        BlocProvider(
            create: (_) => SubmenuHomeBloc()..add(SubMenuGetDataEvent())),
        BlocProvider(
            create: (_) => TreasureHomeBloc()..add(TreasureGetDataEvent()))
      ],
